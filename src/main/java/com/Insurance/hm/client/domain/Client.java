...
public class Client extends BaseTime {
    ...
    @Builder
    public Client(String name, int age, String accountNumber, String address, int creditRating, String phoneNumber,
                  String email, Bank bank, Gender gender, Job job, RRN rrn) {
        this.name = name;
        this.age = age;
