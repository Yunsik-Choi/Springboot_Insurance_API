...
public class IncorrectContractStatusForCreateClaim extends BusinessException {
    public IncorrectContractStatusForCreateClaim(ErrorConstants errorConstants) {
